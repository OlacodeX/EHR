...
class Demo
{
    ...
    public function simulate()
    {
        ...
        $diagnosis = $this->diagnosisClient->loadDiagnosis($selectedSymptoms, $gender, $yearOfBirth);
        if (!isset($diagnosis))
            exit();
        ...
        // get specialisations
        $specialisations = $this->diagnosisClient->loadSpecialisations($selectedSymptoms, $gender, $yearOfBirth);
        ...
        $proposedSymptoms = $this->diagnosisClient->loadProposedSymptoms($selectedSymptoms, $gender, $yearOfBirth);
...
$demo = new Demo();
$demo->simulate();
//echo '<a href="" class="btn btn-danger">Valid Diagnosis</a>';
